...
export default function ProfilePage() {
  ...
  return (
    <section className="grid grid-rows-[30%_1fr] lg:grid-rows-[70px_1fr_70px] lg:grid-cols-[auto_350px_450px_auto] md:grid-rows-[70px_1fr_70px] md:grid-cols-[auto_250px_350px_auto] gap-2 h-full  ">
      <div className="py-2 md:col-start-2 md:col-end-3 md:row-start-2 md:row-end-3 flex flex-col gap-2">
        ...
        <ul className="flex flex-col gap-1 px-2">
          <LinkPage content="Profile" to="edit-profile" isActive={active} setActive={handleActive}/>
          <LinkPage content="Photo" to="edit-photo" isActive={active} setActive={handleActive}/>
        </ul>
      </div>
